...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        Root.add(panel1, gbc);
        panel1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(-4473925)), "Entity Table Manager", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        buttonForceUnlock = new JButton();
        buttonForceUnlock.setMaximumSize(new Dimension(78, 30));
        buttonForceUnlock.setMinimumSize(new Dimension(78, 30));
        buttonForceUnlock.setPreferredSize(new Dimension(78, 30));
        buttonForceUnlock.setText("Force Unlock");
        gbc = new GridBagConstraints();
        gbc.gridx = 2;
        gbc.gridy = 0;
        gbc.weightx = 0.25;
        gbc.weighty = 0.1;
        gbc.fill = GridBagConstraints.BOTH;
        panel1.add(buttonForceUnlock, gbc);
        buttonPurge = new JButton();
        buttonPurge.setText("Purge");
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 0;
        gbc.weightx = 0.25;
        ...
        listEntityTables = new JList();
        listEntityTables.setSelectionMode(0);
        scrollPane1.setViewportView(listEntityTables);
        buttonAssure = new JButton();
        buttonAssure.setText("Assure");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.weightx = 0.25;
        gbc.weighty = 0.1;
        gbc.fill = GridBagConstraints.BOTH;
        panel1.add(buttonAssure, gbc);
        buttonRefresh = new JButton();
        buttonRefresh.setMaximumSize(new Dimension(78, 30));
        buttonRefresh.setMinimumSize(new Dimension(78, 30));
        buttonRefresh.setPreferredSize(new Dimension(78, 30));
        buttonRefresh.setText("Refresh Cache");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.weightx = 0.25;
        ...
        gbc.fill = GridBagConstraints.BOTH;
        Root.add(panel2, gbc);
        panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(-4473925)), "Database Actions", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        buttonForceUnlockAll = new JButton();
        buttonForceUnlockAll.setActionCommand("Force Unlock All");
        buttonForceUnlockAll.setLabel("Force Unlock All");
        buttonForceUnlockAll.setMaximumSize(new Dimension(82, 30));
        buttonForceUnlockAll.setMinimumSize(new Dimension(82, 30));
        buttonForceUnlockAll.setPreferredSize(new Dimension(82, 30));
        buttonForceUnlockAll.setText("Force Unlock All");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.weightx = 0.25;
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel2.add(buttonForceUnlockAll, gbc);
        buttonPurgeAll = new JButton();
        buttonPurgeAll.setText("Purge All");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.weightx = 0.25;

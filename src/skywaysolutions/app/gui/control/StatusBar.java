...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        Root.setMinimumSize(new Dimension(45, 36));
        Root.setPreferredSize(new Dimension(45, 36));
        ...
        helpButton.setMaximumSize(new Dimension(36, 36));
        helpButton.setMinimumSize(new Dimension(36, 36));

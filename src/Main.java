...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 5) {
            ...
            System.out.println("<database host> <database port> <database name> <database username> <database password>");
        ...
        try {
            ...
            new skywaysolutions.app.gui.Main("AirVia ATS", conn, latch);
            latch.await();
